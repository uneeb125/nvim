return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>cr", crates.reload, { desc = "Crates: Reload/Clear Cache" })

        vim.keymap.set("n", "<leader>cv", crates.show_versions_popup, { desc = "Crates: Versions Popup" })
        vim.keymap.set("n", "<leader>cf", crates.show_features_popup, { desc = "Crates: Features Popup" })
        vim.keymap.set("n", "<leader>cd", crates.show_dependencies_popup, { desc = "Crates: Dependencies Popup" })

        vim.keymap.set("n", "<leader>cu", crates.update_crate, { desc = "Crates: Update Crate (Compatible)" })
        ...
        vim.keymap.set("n", "<leader>cU", crates.upgrade_crate, { desc = "Crates: Upgrade Crate (Newest)" })
        ...
        vim.keymap.set("n", "<leader>cx", crates.expand_plain_crate_to_inline_table, { desc = "Crates: Expand to Inline Table" })
        vim.keymap.set("n", "<leader>cX", crates.extract_crate_into_table, { desc = "Crates: Extract into Table" })
        vim.keymap.set("n", "<leader>cg", crates.use_git_source, { desc = "Crates: Use Git Source" })
        ...
        vim.keymap.set("n", "<leader>cL", crates.open_lib_rs, { desc = "Crates: Open lib.rs" })
    end,
}
